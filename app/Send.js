...
export default function Send() {
    ...
    useEffect(() => {
        const shouldShow = amount && !isNaN(amount) && parseFloat(amount) > 0 && recipientAddress;
            ...
            >
                ...
                <View style={styles.inputSection}>
                    ...
                    <View style={[
                        ...
                        recipientAddress && !validateStarknetAddress(recipientAddress) && styles.inputError
                    ]}>
                        <TextInput
                    ...
                    {recipientAddress && !validateStarknetAddress(recipientAddress) && (
                        <Text style={styles.errorText}>Invalid Starknet address format</Text>
                    )}
                </View>
                    ...
                    >
                        ...
                        <View style={styles.summaryContent}>
                            ...
                            <View style={styles.summaryRow}>
                                ...
                                <Text style={[styles.summaryValue, styles.freeTag]}>
                                    FREE
                                </Text>
                            </View>
                            ...
                            <View style={styles.totalRow}>
                                ...
                                <Text style={[
                                    styles.totalValue,
                                    calculateFees(amount).totalAmount > balance && styles.totalValueError
                                ]}>
                ...
                <TouchableOpacity
                    style={[
                        styles.sendButton,
                        (!amount || isNaN(amount) || parseFloat(amount) <= 0 || !recipientAddress || !validateStarknetAddress(recipientAddress)) &&
                        styles.disabledButton
                    ]}
                    onPress={handleSend}
                    disabled={!amount || isNaN(amount) || parseFloat(amount) <= 0 || !recipientAddress || !validateStarknetAddress(recipientAddress)}
                >
